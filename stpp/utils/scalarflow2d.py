...
def create_argparser() -> argparse.ArgumentParser:
    ...
    # Data.
    parser.add_argument("--data_dir", type=str, default="./data/ScalarFlow2D/", help="Path to the dataset.")
    ...
    parser.add_argument("--n_iters", type=int, default=3000, help="Number of training iterations.")
    ...
    parser.add_argument("--model_dir", type=str, default="./models/ScalarFlow2D/", help="Folder for saving/loading models.")
...
def create_model(cfg: SimpleNamespace) -> Model:
    ...
    lm = nn.Sequential(
        ...
        IntensityCorrection(0.0000000001),
    )
